  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 blur-3xl -z-10"></div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Card className="p-8 border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-card to-card/50">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Enter your company details and registration info</p>
            </div>
          </div>
        ...
        <Card className="p-8 border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-card to-card/50">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500 to-cyan-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">
              2
            </div>
            <div>
              <h3 className="text-xl font-bold">Plant Locations</h3>
              <p className="text-sm text-muted-foreground">Add your manufacturing or warehouse locations</p>
            </div>
          </div>
        ...
        <Card className="p-8 border-2 hover:border-primary/50 transition-all duration-300 hover:shadow-xl bg-gradient-to-br from-card to-card/50">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h3 className="text-xl font-bold">Primary Contact</h3>
              <p className="text-sm text-muted-foreground">Provide verified contact information</p>
            </div>
          </div>
